...
# @click.option("--project_name", required=True, help="Name of the project directory")
def make_data(raw_dir: str, processed_dir: str, project_name: str):
   
    # Construct paths using the project_name
    raw_dir = os.path.join(project_name, raw_dir)
